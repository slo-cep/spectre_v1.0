...
#ifndef SIMPLESELECTION_HPP
#define SIMPLESELECTION_HPP
...
namespace selection
{
class SimpleSelection : public AbstractSelection
{
public:
    /**
     * Constructor
     ...
     */
    SimpleSelection(unsigned long id, GlobalEventStreamTypedef &globalEventStream,
                    AbstractSelection *predecessorSelection, GlobalEventStreamTypedef_iterator startPosition,
                    profiler::Measurements *measurements);


    /**
     * @brief SimpleSelection: Copy constructor
     * @param other: rhs
     */
    SimpleSelection(const SimpleSelection &other);
