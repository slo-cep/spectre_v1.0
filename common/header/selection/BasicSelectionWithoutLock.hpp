/*
 * BasicSelectionWithoutLock.hpp
 *
 * Created on: 05.01.2017
 *      Author: sload
 */

#ifndef BASICSELECTIONWITHOUTLOCK_HPP
#define BASICSELECTIONWITHOUTLOCK_HPP
 ...
 *
 */
class BasicSelectionWithoutLock
{
public:
     ...
     */
    BasicSelectionWithoutLock(unsigned long id, GlobalEventStreamTypedef &globalEventStream,
...
//    int getSize() const;
    ...
    virtual ~BasicSelectionWithoutLock();
...
//    int size;
    ...
    atomic<unsigned long> lastEventSn={0};
...
#endif // BASICSELECTIONWITHOUTLOCK_HPP
